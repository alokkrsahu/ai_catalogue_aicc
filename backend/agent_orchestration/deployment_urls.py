...
urlpatterns = [
    ...
    # Public streaming endpoint (unauthenticated)
    path('api/workflow-deploy/<uuid:project_id>/stream/', public_chat_endpoint_stream, name='workflow-deploy-public-stream'),
