...
class ContentExtractionTests(TestCase):
    ...
    def test_spa_warning_set_when_only_mount_point(self):
        """Empty body + SPA mount + many scripts → extraction_error + warning."""
        html = """
        ...
        # No sections → warning promoted to extraction_error.
        self.assertEqual(cap.extraction_error, cap.spa_warning)
